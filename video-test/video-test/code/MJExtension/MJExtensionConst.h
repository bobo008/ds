...
FOUNDATION_EXPORT NSString *const MJPropertyTypeCGRect;
FOUNDATION_EXPORT NSString *const MJPropertyTypeCGPoint;

FOUNDATION_EXPORT NSString *const MJPropertyTypeCMTimeRange;
