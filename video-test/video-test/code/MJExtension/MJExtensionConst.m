...
// 新增一些类型
NSString *const MJPropertyTypeCGRect = @"{CGRect={CGPoint=dd}{CGSize=dd}}";

NSString *const MJPropertyTypeCGPoint = @"{CGPoint=dd}";

NSString *const MJPropertyTypeCMTimeRange = @"{?={?=qiIq}{?=qiIq}}";
