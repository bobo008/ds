...
@interface THBMutiMetalNode ()

@property (nonatomic) id<MTLTexture> dstTexture;
@property (nonatomic) id<MTLTexture> dstTexture2;
...
@implementation THBMutiMetalNode
...
- (void)setup {
    ...
    }
    {
        ...
        texDescriptor.storageMode = MTLStorageModeShared;
        texDescriptor.usage = MTLTextureUsageRenderTarget | MTLTextureUsageShaderRead;
        self.dstTexture2 = [device newTextureWithDescriptor:texDescriptor];
    }
    ...
    renderToTextureRenderPassDescriptor.colorAttachments[1].texture = self.dstTexture2;
    renderToTextureRenderPassDescriptor.colorAttachments[1].loadAction = MTLLoadActionClear;
    renderToTextureRenderPassDescriptor.colorAttachments[1].clearColor = MTLClearColorMake(0, 0, 0, 0);
    renderToTextureRenderPassDescriptor.colorAttachments[1].storeAction = MTLStoreActionStore;
    ...
    pipelineStateDescriptor.vertexFunction =  [defaultLibrary newFunctionWithName:@"mutiVertexShader"];
    pipelineStateDescriptor.fragmentFunction =  [defaultLibrary newFunctionWithName:@"mutiFragmentShader"];
    pipelineStateDescriptor.colorAttachments[0].pixelFormat = self.dstTexture.pixelFormat;
    pipelineStateDescriptor.colorAttachments[1].pixelFormat = self.dstTexture2.pixelFormat;
