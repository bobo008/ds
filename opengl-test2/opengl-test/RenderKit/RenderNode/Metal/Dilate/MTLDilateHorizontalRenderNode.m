...
#import "MTLDilateHorizontalRenderNode.h"
...
@interface MTLDilateHorizontalRenderNode ()
...
@implementation MTLDilateHorizontalRenderNode
...
- (void)render {
    ...
    id<MTLRenderPipelineState> renderToTextureRenderPipeline = [device renderPipelineStateWithVertexFunction:@"oneInputVertexShader" fragmentFunction:@"dilateHFragmentShader" pixelFormat:self.outputTexture.texture.pixelFormat];
