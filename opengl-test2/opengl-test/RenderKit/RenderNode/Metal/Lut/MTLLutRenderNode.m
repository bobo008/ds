...
@implementation MTLLutRenderNode
...
- (void)render {
    ...
    id<MTLRenderPipelineState> renderToTextureRenderPipeline = [device renderPipelineStateWithVertexFunction:@"oneInputVertexShader" fragmentFunction:@"lutFragmentShader" pixelFormat:self.outputTexture.texture.pixelFormat];
    ...
    [renderEncoder setFragmentTexture:self.lutTexture.texture atIndex:PPPTextureInputIndexTexture1];
    

    [renderEncoder setFragmentBytes:&_intensity length:sizeof(float) atIndex:0];
