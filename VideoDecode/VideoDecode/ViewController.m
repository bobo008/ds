...
- (void)createSubview
{
    UIButton *startCaptureButton = [[UIButton alloc] initWithFrame:CGRectMake(00.f, 500.f, 300, 50.f)];
    ...
    UIButton *stopCaptureButton = [[UIButton alloc] initWithFrame:CGRectMake(00.f, 550.f, 300, 50.f)];
    ...
    UIButton *closeFileButton = [[UIButton alloc] initWithFrame:CGRectMake(00.f, 600.f, 300, 50.f)];
...
- (void)createVideoEncoderAndDecoder
{
    ...
    // 显示解码后的数据
    CGSize size = CGSizeMake(self.view.frame.size.width/2, self.view.frame.size.height/2);
    _displayLayer = [[AAPLEAGLLayer alloc] initWithFrame:CGRectMake(self.view.frame.size.width/2, 100, size.width, size.height)];
